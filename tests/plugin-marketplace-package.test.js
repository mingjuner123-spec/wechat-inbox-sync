...
assert.strictEqual(manifest.version, '1.3.87');
...
assert.ok(
  /PLUGIN_RUNTIME_VERSION\s*=\s*["']1\.3\.87["']/.test(pluginMainSource),
  'marketplace main.js runtime identity must match manifest version 1.3.87',
);
