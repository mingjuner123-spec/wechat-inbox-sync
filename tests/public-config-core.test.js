...
assert.strictEqual(DEFAULT_ANNOUNCEMENT, '插件 v1.3.2 已发布：修复绑定码与 Pro 权限链路，飞书文档转存可优先使用官方 API 通道。');
assert.strictEqual(DEFAULT_PLUGIN_VERSION, '1.3.2');
assert.strictEqual(DEFAULT_PLUGIN_UPDATED_AT, '2026-07-05 07:13');
assert.strictEqual(DEFAULT_ANNOUNCEMENT_VERSION, '2026-07-05-plugin-132-market-update');
