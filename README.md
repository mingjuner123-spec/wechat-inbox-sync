...
[MIT License with the Commons Clause License Condition v1.0](LICENSE). Personal
use, internal use, modification, and contribution are allowed under those
terms, but the plugin or a product/service whose value substantially derives
from its functionality may not be sold without separate permission.
