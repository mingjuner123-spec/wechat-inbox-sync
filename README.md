...
- Save uploaded files as local attachments and extract Markdown from `txt`, `md`, `docx`, and text-based `pdf` files on desktop.
- Obsidian mobile runs in a lightweight mode for text and supported public graphic articles; audio/video and file records remain in the cloud for desktop sync.
...
- Obsidian desktop app for the full feature set, or Obsidian mobile for lightweight text/public graphic article sync.
