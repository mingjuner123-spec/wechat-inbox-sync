...
- 独立审查发现初版仅用子串判断 `-InstallRoot`，邻近目录可能被误认成同一 ASR 安装目录；已改为解析 PowerShell 参数并对规范化绝对路径做完整等值比较，新增路径前后缀、空格、单双引号与等号形式回归。
- 已验证修正版候选：`1.3.130-da91e47098fbb30c`，aggregate SHA-256 `da91e47098fbb30c054564a62a421e619995c9a7dcf78e71553d44f41e323f1b`。
