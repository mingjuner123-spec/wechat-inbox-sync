...
- 已验证候选：`1.3.130-a0e0cecbbd5bd6ac`，aggregate SHA-256 `a0e0cecbbd5bd6ac4b0a371db47414211ef8151d849437b10b33d8ed91ad3ccd`。
- 本地正式 CI 门禁与本次专项回归共 37 个测试文件通过；组件 manifest、私有访问策略、语法、候选安装/回读/晋升均通过。发布仍须完成联合差异独立审查、远端版本空闲复核、受保护 main PR、tag/Release 与发布后逐层验收。
