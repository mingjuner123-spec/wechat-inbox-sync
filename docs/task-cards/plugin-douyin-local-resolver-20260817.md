...
- Status: in progress (lightweight revision: no automatic installation, polling, or scheduled mirror)
...
1. Normal sync never downloads or checks yt-dlp. The optional component is installed or updated only by a user-triggered settings action.
